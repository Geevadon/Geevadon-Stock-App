...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-3">
        ...
        <a href="{{ route ('order-history.index') }}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-list fa-sm text-white-50"></i> Historique</a>
    </div>
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <ul class="list-group">
                ...
                <li class="list-group-item">Statut : <b>{{ $order->status == 'trash_not_paid' ? 'Corbeille (non payé' : 'Corbeille (payé)' }}</b></li>
