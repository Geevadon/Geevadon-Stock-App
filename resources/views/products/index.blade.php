...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-3">
        ...
        <a href="{{ route ('products.create') }}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-plus fa-sm text-white-50"></i> Nouveau Produit</a>
    </div>
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary"><i class="fa fa-list"></i> Liste de Produits</h6>
        </div>
        <div class="card-body">
                                ...
                                <td>
                                    <div class="dropleft">
                                        ...
                                        <div class="dropdown-menu border border-dark" aria-labelledby="dropdownMenuButton">
                                            ...
                                            <a class="dropdown-item" href="{{ route ('products.stock.card.value', $product->id)}}"><i class="fa fa-file"></i> Fiche de Stock (valeur)</a>

                                            <div class="dropdown-divider"></div>

                                            <a class="dropdown-item" href="{{ route ('products.stock.card.quantity', $product->id)}}"><i class="fa fa-file"></i> Fiche de Stock (quantité)</a>
