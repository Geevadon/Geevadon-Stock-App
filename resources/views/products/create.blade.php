...
@section('content')
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary"><i class="fa fa-plus"></i> Nouveau Produit</h6>
        </div>
        <div class="card-body">
                ...
                <div class="form-row">
                    <div class="col-md-6 px-3">
                        ...
                        <div class="form-group row">
                            ...
                            <input type="date" class="form-control @error('product_added_date') is-invalid @enderror col-md-8" id="product_added_date" name="product_added_date" value="{{ old ('product_added_date') ?: date ('Y-m-d') }}" required>
                        ...
                        <div class="form-group row">
                            ...
                            <input type="text" class="form-control @error('product_name') is-invalid @enderror col-md-8" id="product_name" name="product_name" value="{{ old ('product_name') }}" required>
                        ...
                        <div class="form-group row">
                            ...
                            <select type="text" class="form-control @error('product_brand') is-invalid @enderror col-md-8" id="product_brand" name="product_brand" value="{{ old ('product_brand') }}" required>
                                ...
                                @foreach ($brands as $brand)
                                    <option value="{{ $brand->id }}" {{ old ('product_brand') == $brand->id ? 'selected' : ''}}>{{ $brand->name }}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-md-6 px-3">
                        ...
                        <div class="form-group row">
                            ...
                            <input type="number" class="form-control @error('product_price') is-invalid @enderror col-md-8" id="product_price" name="product_price" value="{{ old ('product_price') }}" required>
                        ...
                        <div class="form-group row">
                            ...
                            <input type="number" class="form-control @error('product_quantity') is-invalid @enderror col-md-8" id="product_quantity" name="product_quantity" value="{{ old ('product_quantity') }}" required>
                        ...
                        <div class="form-group row">
                            ...
                            <input type="number" class="form-control @error('product_alert') is-invalid @enderror col-md-8" id="product_alert" name="product_alert" value="{{ old ('product_alert') }}" placeholder="5">
